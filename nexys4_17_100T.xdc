...
set_property PACKAGE_PIN C4 [get_ports UART_RXD_IN]
set_property IOSTANDARD LVCMOS33 [get_ports UART_RXD_IN]
##Bank = 35, Pin name = IO_L11N_T1_SRCC_35,                    Sch name = UART_RXD_OUT
set_property PACKAGE_PIN D4 [get_ports UART_TXD_OUT]
set_property IOSTANDARD LVCMOS33 [get_ports UART_TXD_OUT]
##Bank = 35, Pin name = IO_L12N_T1_MRCC_35,                    Sch name = UART_CTS
set_property PACKAGE_PIN D3 [get_ports UART_CTS_OUT]
set_property IOSTANDARD LVCMOS33 [get_ports UART_CTS_OUT]
##Bank = 35, Pin name = IO_L5N_T0_AD13N_35,                    Sch name = UART_RTS
set_property PACKAGE_PIN E5 [get_ports UART_RTS_IN]
set_property IOSTANDARD LVCMOS33 [get_ports UART_RTS_IN]
