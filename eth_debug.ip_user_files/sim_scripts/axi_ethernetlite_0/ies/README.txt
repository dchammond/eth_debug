...
#
# Generated by export_simulation on Tue Feb 23 12:01:53 -0600 2021
#
################################################################################
...
'-reset_run' switch to the './axi_ethernetlite_0.sh' script.

./axi_ethernetlite_0.sh -reset_run
...
./axi_ethernetlite_0.sh -noclean_files

For more information on the script, please type './axi_ethernetlite_0.sh -help'.
