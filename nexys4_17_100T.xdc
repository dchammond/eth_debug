...
set_property IOB TRUE [get_ports PhyCrs]
set_property IOB TRUE [get_ports PhyRxErr]
set_property IOB TRUE [get_ports PhyRxd[0]]
set_property IOB TRUE [get_ports PhyRxd[1]]
...
set_property PACKAGE_PIN K2 [get_ports UartRxdEth]					
	set_property IOSTANDARD LVCMOS33 [get_ports UartRxdEth]
...
set_property PACKAGE_PIN J3 [get_ports UartTxdEth]					
	set_property IOSTANDARD LVCMOS33 [get_ports UartTxdEth]
...
set_property PACKAGE_PIN H4 [get_ports UartRxdDebug]					
	set_property IOSTANDARD LVCMOS33 [get_ports UartRxdDebug]
...
set_property PACKAGE_PIN G1 [get_ports UartTxdDebug]					
	set_property IOSTANDARD LVCMOS33 [get_ports UartTxdDebug]
